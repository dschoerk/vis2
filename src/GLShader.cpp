...
std::string GL::readFile(const char *filePath)
{
  std::string content;
...
GL::GLShader::GLShader(const std::string& filename, GLShaderType _type) : GLShader(filename.c_str(), _type)
{
}

GL::GLShader::GLShader(const char* filename, GLShaderType _type) : type(_type)
{
