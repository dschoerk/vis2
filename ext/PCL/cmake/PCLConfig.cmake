...
macro(find_openni)
  if(NOT OPENNI_ROOT AND ("" STREQUAL "ON"))
    ...
    get_filename_component(OPENNI_LIBRARY_HINT "C:/Program Files/OpenNI/Lib64/openNI64.lib" PATH)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "C:/Programming/pcl")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters 2d geometry features ml segmentation surface registration keypoints tracking recognition stereo )
...
set(pcl_io_opt_dep openni openni2 ensenso pcap png vtk )
